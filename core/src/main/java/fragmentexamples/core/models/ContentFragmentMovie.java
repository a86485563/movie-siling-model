...
public class ContentFragmentMovie {
    public static final String STATIC_MODEL_TITLE = "Movie";
   // public static final String MODEL_TITLE = "movieCFTitle";
    ...
    public List<ContentFragmentActor> getActors() {
        List<ContentFragmentActor> result = 
         Arrays.asList((String[]) contentFragment
